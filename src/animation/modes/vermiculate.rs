...
fn random1(rng: &mut impl Rng, i: u32) -> u32 {
...
impl Vermiculate {
    ...
    fn newonscreen(&mut self, thr: usize, rng: &mut impl Rng) {
        let hei = self.hei;
        let wid = self.wid;
    ...
    fn firstinit(&mut self, thr: usize, rng: &mut impl Rng) {
        let t = thr as i32;
        let lp = &mut self.thread[thr - 1];
        lp.col = (thr + 1) as u8;
        lp.prey = 0;
    ...
    fn maininit(&mut self, rng: &mut impl Rng) {
    ...
    fn move_thread(&mut self, thr: usize, rng: &mut impl Rng) -> bool {
    ...
    fn consume_instring(&mut self, rng: &mut impl Rng) {
