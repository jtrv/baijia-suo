...
fn myrnd(rng: &mut impl RngExt) -> f32 {
...
fn stars_perturb(var: f32, op: f32, damp: f32, force: f32, rng: &mut impl RngExt) -> f32 {
...
impl WhirlwindWarp {
    fn stars_newp(&mut self, rng: &mut impl RngExt, pp: usize) {
    ...
    fn turn_on_field(&mut self, rng: &mut impl RngExt, ff: usize) {
        if !self.fon[ff] {
