...
fn rnd(rng: &mut impl RngExt, q: i32) -> i32 {
...
fn init_color(rng: &mut impl RngExt) -> (i32, i32, i32) {
    (
        rnd(rng, 50000) + 10000,
        rnd(rng, 50000) + 10000,
        rnd(rng, 50000) + 10000,
...
impl ColorChanger {
    fn new(rng: &mut impl RngExt) -> ColorChanger {
...
impl Wormhole {
    ...
    fn add_star(&mut self, rng: &mut impl RngExt) {
        let ang = rnd(rng, 360);
