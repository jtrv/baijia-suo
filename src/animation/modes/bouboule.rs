...
fn nrand(rng: &mut impl RngExt, n: i32) -> i32 {
    if n <= 1 {
        0
    } else {
...
impl SinVariable {
    fn new(rng: &mut impl RngExt, alpha: f64, step: f64, minimum: f64, maximum: f64, mayrand: i32) -> Self {
    ...
    fn vary(&mut self, rng: &mut impl RngExt) {
