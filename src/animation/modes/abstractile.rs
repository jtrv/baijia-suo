...
impl Abstractile {
    ...
    fn getdeo(&self, x: i32, y: i32, map: i32, de: usize, line: &Line, rng: &mut impl RngExt) -> i32 {
        match map {
            /* horizontal one side */
            0 => x,
            /* vertical one side */
    ...
    fn init_zlist(&mut self, rng: &mut impl RngExt) {
    ...
    fn init_colors(&mut self, rng: &mut impl RngExt) {
    ...
    fn create_step(&mut self, rng: &mut impl RngExt) {
    ...
    fn init_screen(&mut self, rng: &mut impl RngExt) {
        self.ii += 1;
    ...
    fn findopen(&mut self, x: i32, y: i32, z: usize, rng: &mut impl RngExt) -> i32 {
    ...
    fn newline(&mut self, rng: &mut impl RngExt) {
        let mut bl = 0usize;
...
fn smooth_points(rng: &mut impl RngExt) -> (Vec<i32>, Vec<f64>, Vec<f64>) {
    let npoints = {
