...
fn random_double(rng: &mut impl Rng, base: f64, limit: f64, epsilon: f64) -> f64 {
...
fn select_2_pattern(rng: &mut impl Rng, segments: &mut [Segment]) {
...
fn select_3_pattern(rng: &mut impl Rng, segments: &mut [Segment]) {
...
fn select_4_pattern(rng: &mut impl Rng, segments: &mut [Segment]) {
...
fn select_pattern(rng: &mut impl Rng, segment_count: usize) -> Vec<Segment> {
