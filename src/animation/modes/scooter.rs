...
fn randomcolor(rng: &mut impl RngExt) -> ColorRGB {
...
impl Scooter {
    ...
    fn nextdoorcolor(&mut self, door_index: usize, rng: &mut impl RngExt) {
    ...
    fn calc_new_element(&mut self, rng: &mut impl RngExt) {
    ...
    fn shift_elements(&mut self, rng: &mut impl RngExt) {
