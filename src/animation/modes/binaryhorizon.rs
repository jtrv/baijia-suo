...
impl BinaryHorizon {
    fn next_color(&self, current: Rgb, rng: &mut impl RngExt) -> Rgb {
        if self.fade {
    ...
    fn init_particle(p: &mut Particle, dx: f32, dy: f32, direction: f32, color: Rgb, max_age: i32, rng: &mut impl RngExt) {
