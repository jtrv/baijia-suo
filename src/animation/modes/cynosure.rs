...
fn make_smooth_colormap(ncolors: usize, rng: &mut impl RngExt) -> Vec<(u16, u16, u16)> {
...
impl Cynosure {
    ...
    fn c_tweak(&self, rng: &mut impl RngExt, base: i32, tweak: i32) -> i32 {
    ...
    fn gen_constrained_color(&self, rng: &mut impl RngExt, base: i32) -> i32 {
    ...
    fn gen_new_color(&mut self, rng: &mut impl RngExt) -> usize {
        if self.time_left == 0 {
    ...
    fn paint(&mut self, rng: &mut impl RngExt) {
